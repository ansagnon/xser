source(here::here("src/package_iphra_tools/utils/utils_analysis.R"))
source(here::here("src/package_iphra_tools/utils/misc_utils.R"))
source(here::here("src/package_iphra_tools/utils/utils_descriptive_analysis.R"))
source(here::here("src/package_iphra_tools/utils/kobo_utils.R"))
source(here::here("src/package_iphra_tools/utils/check_kobo.R"))
source(here::here("src/package_iphra_tools/utils/tabular_analysis_utils.R"))
source(here::here("src/package_iphra_tools/functions_phu.R"))
...
## TABULAR  -------------------------------------------------------------------
# source('iphra_analysis/src/analysis_tabular.Rmd') # 'src/analysis_tabular.Rmd'

rmarkdown::render('iphra_analysis/src/analysis_tabular.Rmd',
...
# C:/Users/User/OneDrive - ACTED/Bureau/16-10-2023/Tâche 1/ACF/IPHRA_ANALYSIS/iphra_analysis/resources/daf.xlsx
# daf <- readxl::read_excel("C:/Users/User/OneDrive - ACTED/Bureau/16-10-2023/Tâche 1/ACF/IPHRA_ANALYSIS/iphra_analysis/resources/daf.xlsx", col_types = "text") %>%
#   filter(!is.na(variable))
cat("\n> Checking your DAF...\n")
